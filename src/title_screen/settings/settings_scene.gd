...
onready var _crt_checkbox: CheckBox = $"VBoxContainer/PanelContainer/TabContainer/OtherSettings/Container/CrtCheckbox"
...
func _prepare_other() -> void:
	...
	_crt_checkbox.pressed = Settings.crt_effect
...
func _on_CrtCheckbox_toggled(button_pressed: bool) -> void:
	Settings.crt_effect = button_pressed
